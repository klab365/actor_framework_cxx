 ...
 *
 * IPC_PAYLOAD_SIZE is the only public sizing override. It controls the
 * inline payload bytes carried by struct ipc_msg; IPC_*_DEFINE payloads
 * must fit this cap at compile time.
 *
 * Override paths:
 ...
 *      maps it to IPC_PAYLOAD_SIZE before including this default.
 */
#pragma once
